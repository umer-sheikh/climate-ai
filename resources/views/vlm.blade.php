                    ...
                    <div class="card">
                        <div class="chat">
                            <div class="chat-header clearfix">
                                ...
                                <div class="chat-about">
                                    <div class="chat-with">VLM Disaster Assesment</div>
                        ...
                        <div class="chat-box" id="mychatbox">
                            ...
                            <div class="card-footer chat-form">
                                <form id="chat-form">
                                    <input type="file" name="image" id="image" style="margin: 10px;" multiple>
    ...
    @section('js')
        ...
        <script>
            ...
            $("#chat-form").submit(function () {
                ...
                if (me.find('input#msg').val().trim().length > 0) {

                    let msg = me.find('input#msg').val();
                    $.chatCtrl('#mychatbox', {
                    text: msg,
